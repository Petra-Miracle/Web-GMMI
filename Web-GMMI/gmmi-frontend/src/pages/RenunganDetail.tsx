        ...
        return (
            <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
                ...
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-2xl font-bold text-gmmi-navy">Renungan Tidak Ditemukan</h2>
                        ...
                        <div className="max-w-4xl">
                            <div className="flex flex-wrap gap-4 mb-6">
                                ...
                                <div className="px-4 py-2 bg-white/10 backdrop-blur-md rounded-full flex items-center gap-2 border border-white/10">
                                    ...
                                    <span className="text-xs font-bold uppercase tracking-wide">Renungan Mingguan</span>
                                </div>
                            </div>
                ...
                <div className="bg-white rounded-[3rem] shadow-xl shadow-gmmi-navy/5 p-8 md:p-16 max-w-5xl mx-auto border border-white">
                    ...
                    <div className="mt-16 pt-10 border-t border-neutral-100 flex justify-between items-center">
                        ...
                        <div className="flex gap-4">
                            <Button isIconOnly radius="full" variant="flat" className="bg-neutral-100 text-gmmi-navy hover:bg-gmmi-gold hover:text-white transition-colors">
                                <Share2 size={18} />
                            </Button>
                        </div>
                    </div>
