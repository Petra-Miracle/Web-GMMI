...
import { getTransactions, exportTransactions } from '../services/keuangan.service';
                                ...
                                <CardBody className="p-8 md:p-10">
                                    <div className="flex justify-between items-start mb-8">
                                        ...
                                        <div className="flex flex-col items-end">
                                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-1">Update Terakhir</span>
                                            <span className="text-sm font-bold text-gmmi-navy">Februari 2026</span>
                                        </div>
                                    </div>
                                    <div>
                                        <p className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-2">Saldo Akhir Kas</p>
                        ...
                        <motion.div variants={itemVariants}>
                            <Card className="bg-gmmi-navy border border-white/10 shadow-2xl shadow-gmmi-navy/20 rounded-[2.5rem] overflow-hidden group">
                                <CardBody className="p-8 md:p-10">
                                    ...
                                    <div>
                                        <p className="text-sm font-bold text-white/40 uppercase tracking-widest mb-2">Saldo Akhir Bank</p>
                        ...
                        >
                            <div className="flex flex-col md:flex-row gap-4 items-end w-full md:w-auto">
                                <div className="space-y-2 w-full md:w-48">
                                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Dari Tanggal</label>
                                    <Input
                                        type="date"
                                        variant="bordered"
                                ...
                                <div className="space-y-2 w-full md:w-48">
                                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Sampai Tanggal</label>
                                    <Input
                                        type="date"
                                        variant="bordered"
                                        className="bg-white/50"
                            ...
                            <Button
                                ...
                                onPress={() => exportTransactions(filter.startDate, filter.endDate)}
                            >
                                Download Excel
                            </Button>
                        </motion.div>
                        ...
                        <motion.div variants={itemVariants}>
                            <Card className="bg-white/80 backdrop-blur-xl border border-white/50 shadow-2xl shadow-gmmi-navy/5 rounded-[2.5rem] overflow-hidden">
                                <CardBody className="p-0">
                                    ...
                                    >
                                        <TableHeader>
                                            <TableColumn className="bg-slate-50/50 py-6 font-black uppercase tracking-widest text-[10px]">Tanggal</TableColumn>
                                            <TableColumn className="bg-slate-50/50 py-6 font-black uppercase tracking-widest text-[10px]">Keterangan</TableColumn>
                                            <TableColumn className="bg-blue-50/50 py-6 font-black uppercase tracking-widest text-[10px] text-right">Kas Masuk</TableColumn>
                                            <TableColumn className="bg-blue-50/50 py-6 font-black uppercase tracking-widest text-[10px] text-right">Kas Keluar</TableColumn>
                                            <TableColumn className="bg-emerald-50/50 py-6 font-black uppercase tracking-widest text-[10px] text-right">Bank Debit</TableColumn>
                                            <TableColumn className="bg-emerald-50/50 py-6 font-black uppercase tracking-widest text-[10px] text-right">Bank Kredit</TableColumn>
                                        </TableHeader>
                                        <TableBody
                                            isLoading={loading}
                                        ...
                                        >
                                            {transactions.map((row) => (
                                                <TableRow key={row.id} className="border-b border-slate-50 hover:bg-slate-50/30 transition-colors">
                                                    ...
                                                    <TableCell className="py-5 font-medium text-slate-600 max-w-[300px] line-clamp-1">{row.keterangan}</TableCell>
                                                    <TableCell className="py-5 text-right font-bold text-blue-600">{formatRp(row.kas_penerimaan)}</TableCell>
                                                    <TableCell className="py-5 text-right font-bold text-rose-500">{formatRp(row.kas_pengeluaran)}</TableCell>
                                                    <TableCell className="py-5 text-right font-bold text-emerald-600">{formatRp(row.bank_debit)}</TableCell>
                                                    <TableCell className="py-5 text-right font-bold text-rose-500">{formatRp(row.bank_kredit)}</TableCell>
                                                </TableRow>
                                            ))}
                                        </TableBody>
                                    </Table>
