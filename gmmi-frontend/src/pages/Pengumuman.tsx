                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-16">
                    <div className="relative w-full md:max-w-md group">
                        <Input
                            ...
                            variant="bordered"
                            classNames={{
                                inputWrapper: "bg-white border-neutral-100 group-hover:border-gmmi-gold/50 transition-colors h-16"
                            }}
                        />
                    </div>
                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    {loading ? (
                        Array(3).fill(0).map((_, i) => (
                            <Card key={i} className="p-10 space-y-4 rounded-[2.5rem]" radius="lg">
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
                                        <div className="flex flex-col items-center justify-center p-6 bg-gmmi-navy text-white rounded-[2rem] min-w-[120px] shadow-xl shadow-gmmi-navy/20">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-tighter text-slate-400">Update</span>
                                        ...
                                        <div className="flex-grow space-y-4 pt-2">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-[10px] font-black text-gmmi-gold uppercase tracking-[0.3em]">Pengumuman Resmi</span>
                                            </div>
                        ...
                        <div className="text-center py-32 bg-white rounded-[4rem] border border-neutral-100 shadow-sm leading-none">
                            ...
                            <h3 className="text-2xl font-bold text-gmmi-navy mb-3">Tidak ada pengumuman</h3>
                            <p className="text-neutral-400">Belum ada pengumuman terbaru saat ini.</p>
                        </div>
                    )}
                </div>
            </main>
            ...
            <section className="py-24 container mx-auto px-6">
                <Card className="bg-gmmi-gold p-16 rounded-[4rem] flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl shadow-gmmi-gold/20 overflow-hidden relative">
                    ...
                    <div className="relative z-10 space-y-4">
                        <h2 className="text-4xl md:text-5xl font-bold text-gmmi-navy tracking-tight">Tetap Terhubung dengan <br /> Kegiatan Gereja</h2>
                        <p className="text-gmmi-navy/70 text-lg max-w-xl">Ikuti terus perkembangan pelayanan dan pengumuman terbaru melalui website resmi GMMI.</p>
                    </div>
