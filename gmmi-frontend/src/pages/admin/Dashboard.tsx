    ...
    return (
      <div className="space-y-8 p-4 md:p-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {Array(4).fill(0).map((_, i) => <Skeleton key={i} className="h-32 md:h-40 rounded-[2rem]" />)}
        </div>
      ...
      >
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl md:text-4xl font-black text-gmmi-navy tracking-tight">Dashboard Admin Majelis</h1>
              <p className="text-xs md:text-sm text-gray-500 font-medium">Selamat datang, {user?.name || 'Admin'}</p>
            </div>
          </div>
        </div>
          ...
          <Link to="/admin/pengumuman">
            <Card className="bg-gradient-to-br from-gmmi-navy to-gmmi-navy/90 text-white p-2 rounded-[2rem] md:rounded-[2.5rem] shadow-xl shadow-gmmi-navy/20 relative overflow-hidden group hover:scale-105 transition-transform duration-300 cursor-pointer">
              ...
              <CardBody className="p-4 md:p-6 lg:p-8 space-y-3 md:space-y-4 relative z-10">
                ...
                <div>
                  <p className="text-[10px] md:text-sm font-bold text-gray-300 uppercase tracking-widest">Pengumuman</p>
                  <h3 className="text-2xl md:text-4xl font-extrabold mt-1">{data?.totalAnnouncements || 0}</h3>
                </div>
                <p className="text-[9px] md:text-xs text-gray-400 font-medium italic">Update: {data?.lastUpdateAnnouncements}</p>
              </CardBody>
            </Card>
          </Link>
        </motion.div>
          ...
          <Link to="/admin/warta">
            <Card className="bg-white p-2 rounded-[2rem] md:rounded-[2.5rem] border border-gray-100 shadow-lg relative overflow-hidden group hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
              <CardBody className="p-4 md:p-6 lg:p-8 space-y-3 md:space-y-4">
                ...
                <div>
                  <p className="text-[10px] md:text-sm font-bold text-gray-400 uppercase tracking-widest">Warta Jemaat</p>
                  <h3 className="text-2xl md:text-4xl font-extrabold text-gmmi-navy mt-1">{data?.totalWarta || 0}</h3>
                </div>
                <p className="text-[9px] md:text-xs text-gray-400 font-medium italic">Update: {data?.lastUpdateWarta}</p>
              </CardBody>
            </Card>
          </Link>
        </motion.div>
          ...
          <Link to="/admin/jadwal">
            <Card className="bg-white p-2 rounded-[2rem] md:rounded-[2.5rem] border border-gray-100 shadow-lg relative overflow-hidden group hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
              <CardBody className="p-4 md:p-6 lg:p-8 space-y-3 md:space-y-4">
                ...
                <div>
                  <p className="text-[10px] md:text-sm font-bold text-gray-400 uppercase tracking-widest">Jadwal</p>
                  <h3 className="text-2xl md:text-4xl font-extrabold text-gmmi-navy mt-1">{data?.upcomingServices || 0}</h3>
                </div>
                <p className="text-[9px] md:text-xs text-gray-400 font-medium italic">Update: {data?.lastUpdateJadwal}</p>
              </CardBody>
            </Card>
          </Link>
        </motion.div>
        ...
        >
          <Card className="bg-gradient-to-br from-gmmi-gold to-yellow-500 text-white p-2 rounded-[2rem] md:rounded-[2.5rem] shadow-xl shadow-gmmi-gold/20 relative overflow-hidden group hover:scale-105 transition-transform duration-300 cursor-pointer">
            ...
            <CardBody className="p-4 md:p-6 lg:p-8 space-y-3 md:space-y-4 relative z-10">
              ...
              <div>
                <p className="text-[10px] md:text-sm font-bold text-white/90 uppercase tracking-widest">Program Aktif</p>
                <h3 className="text-2xl md:text-4xl font-extrabold mt-1">{data?.activePrograms || 0}</h3>
              </div>
              <p className="text-[9px] md:text-xs text-white/80 font-medium italic">Total: {data?.totalPrograms || 0} program</p>
            </CardBody>
          </Card>
        </motion.div>
      </div>
            ...
            <Card className="rounded-[2rem] md:rounded-[2.5rem] border border-gray-100 shadow-lg overflow-hidden">
              <div className="p-4 md:p-6 lg:p-8 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg md:text-2xl font-bold text-gmmi-navy">Ringkasan Keuangan</h2>
                    <p className="text-[10px] md:text-xs text-gray-400 font-medium">Bulan ini</p>
                  </div>
                </div>
              ...
              <CardBody className="p-4 md:p-6 lg:p-8 space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                  <Card className="bg-emerald-50/50 border-emerald-100 shadow-sm border rounded-xl md:rounded-2xl">
                    <CardBody className="p-3 md:p-6 flex flex-row items-center gap-3 md:gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-[9px] md:text-[10px] uppercase font-black text-emerald-600 tracking-widest">Pemasukan</p>
                        <h4 className="text-base md:text-2xl font-black text-emerald-800 truncate">Rp {(data?.income || 0).toLocaleString('id-ID')}</h4>
                      </div>
                    </CardBody>
                  </Card>
                  ...
                  <Card className="bg-rose-50/50 border-rose-100 shadow-sm border rounded-xl md:rounded-2xl">
                    <CardBody className="p-3 md:p-6 flex flex-row items-center gap-3 md:gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-[9px] md:text-[10px] uppercase font-black text-rose-600 tracking-widest">Pengeluaran</p>
                        <h4 className="text-base md:text-2xl font-black text-rose-800 truncate">Rp {(data?.expense || 0).toLocaleString('id-ID')}</h4>
                      </div>
                    </CardBody>
                  </Card>
                  ...
                  <Card className="bg-blue-50/50 border-blue-100 shadow-sm border rounded-xl md:rounded-2xl">
                    <CardBody className="p-3 md:p-6 flex flex-row items-center gap-3 md:gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-[9px] md:text-[10px] uppercase font-black text-blue-600 tracking-widest">Saldo</p>
                        <h4 className="text-base md:text-2xl font-black text-blue-800 truncate">Rp {balance.toLocaleString('id-ID')}</h4>
                      </div>
                    </CardBody>
                  </Card>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-xs md:text-sm font-bold text-gray-600">Efisiensi Keuangan</span>
                    <span className="text-xs md:text-sm font-black text-gmmi-navy">{balancePercentage.toFixed(1)}%</span>
                  </div>
                  <Progress
                    value={balancePercentage}
                    className="h-2 md:h-3"
                    classNames={{
                      indicator: balancePercentage > 50 ? "bg-emerald-500" : "bg-amber-500"
                    }}
                  />
                </div>
                  ...
                  <table className="w-full text-left border-collapse min-w-[500px]">
                    <thead>
                      <tr className="bg-gray-50/50 border-b border-gray-100">
                        <th className="px-3 md:px-6 py-3 md:py-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-400">Tanggal</th>
                        <th className="px-3 md:px-6 py-3 md:py-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-400">Keterangan</th>
                        <th className="px-3 md:px-6 py-3 md:py-4 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-400 text-right">Nominal</th>
                      </tr>
                    </thead>
                      ...
                      {data?.recentFinance && data.recentFinance.length > 0 ? (
                        data.recentFinance.slice(0, 5).map((row: any) => (
                          <tr key={row.id} className="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td className="px-3 md:px-6 py-3 md:py-4 text-[10px] md:text-xs text-slate-600 font-medium truncate max-w-[200px]">{row.keterangan}</td>
                            <td className={`px-3 md:px-6 py-3 md:py-4 text-[10px] md:text-xs font-black text-right ${row.masuk > 0 ? 'text-emerald-600' : 'text-rose-500'}`}>
                              {row.masuk > 0 ? `+ Rp ${row.masuk.toLocaleString('id-ID')}` : `- Rp ${row.keluar.toLocaleString('id-ID')}`}
                            </td>
                          </tr>
                        ))
                      ) : (
                        <tr>
                          <td colSpan={3} className="p-6 md:p-8 text-center text-gray-400 text-xs">Belum ada data keuangan.</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
              ...
              <CardBody className="p-4 md:p-6 space-y-3 md:space-y-4 max-h-[400px] overflow-y-auto">
                {data?.recentActivities && data.recentActivities.length > 0 ? (
                  data.recentActivities.slice(0, 5).map((activity) => (
                    ...
                    >
                      <div className={`p-2 md:p-3 rounded-xl shrink-0 ${activity.type === 'announcement' ? 'bg-amber-50 text-amber-600' :
                        activity.type === 'warta' ? 'bg-blue-50 text-blue-600' : 'bg-red-50 text-red-600'
                        }`}>
                        {activity.type === 'announcement' ? <Megaphone className="w-3 h-3 md:w-4 md:h-4" /> :
                          activity.type === 'warta' ? <BookOpen className="w-3 h-3 md:w-4 md:h-4" /> : <Calendar className="w-3 h-3 md:w-4 md:h-4" />}
                      </div>
      ...
      >
        <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-xl md:rounded-2xl shadow-lg">
          <CardBody className="p-4 md:p-6 text-center">
            ...
            <h4 className="text-xl md:text-3xl font-black">{data?.totalJemaat || 0}</h4>
            <p className="text-[9px] md:text-xs font-bold opacity-90 uppercase tracking-widest">Total Jemaat</p>
          </CardBody>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-indigo-500 to-indigo-600 text-white rounded-xl md:rounded-2xl shadow-lg">
          <CardBody className="p-4 md:p-6 text-center">
            ...
            <h4 className="text-xl md:text-3xl font-black">{data?.totalPrograms || 0}</h4>
            <p className="text-[9px] md:text-xs font-bold opacity-90 uppercase tracking-widest">Program</p>
          </CardBody>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-teal-500 to-teal-600 text-white rounded-xl md:rounded-2xl shadow-lg">
          <CardBody className="p-4 md:p-6 text-center">
            ...
            <h4 className="text-xl md:text-3xl font-black">{data?.activePrograms || 0}</h4>
            <p className="text-[9px] md:text-xs font-bold opacity-90 uppercase tracking-widest">Aktif</p>
          </CardBody>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-xl md:rounded-2xl shadow-lg">
          <CardBody className="p-4 md:p-6 text-center">
            ...
            <h4 className="text-xl md:text-3xl font-black">{((data?.activePrograms || 0) / (data?.totalPrograms || 1) * 100).toFixed(0)}%</h4>
            <p className="text-[9px] md:text-xs font-bold opacity-90 uppercase tracking-widest">Progres</p>
          </CardBody>
        </Card>
      </motion.div>
    </div>
